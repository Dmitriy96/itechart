document.addEventListener('DOMContentLoaded', function(){
    ...
    function showAddAttachmentPopup() {
        ...
        function addNewRow() {
            ...
            fileInput.name = attachmentData[0] + '-' + attachmentData[1];
            hiddenInputList.appendChild(fileInput);
            ...
            for (var i = 0; i < attachmentDataInputIDs.length; i++) {
                ...
                hiddenInputList.appendChild(input);
            }
            var options = {
                year: 'numeric',
                month: 'long',
    ...
    function showEditAttachmentPopup(attachmentTableRow) {
        ...
        function setDataForEdition() {
            for (var i = 0; i < attachmentDataInputIDs.length; i++) {
                ...
                document.getElementById(inputID).value =
                    hiddenInputList.querySelector('[name="' + inputID + checkBox.value + '"]').value;
            }
        }
        ...
        function change() {
            ...
            for (i = 0; i < attachmentDataInputIDs.length; i++) {
                var hiddenInput = hiddenInputList.querySelector('[name="' + attachmentDataInputIDs[i] + checkBox.value + '"]');
    ...
    function deleteAttachment(chosenCheckBox) {
        var hiddenInputList = document.getElementById('hiddenInputList');
        var phoneDataInputIDs = ['file', 'fileName', 'attachingDate', 'attachmentComment'];
        function removeHiddenInputs(value) {
            for (var i = 0; i < phoneDataInputIDs.length; i++) {
                var hiddenInput = hiddenInputList.querySelector('[name="' + phoneDataInputIDs[i] + value + '"]');
